...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton compartilhar;

  @NonNull
  public final Button criar;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.compartilhar;
      ImageButton compartilhar = ViewBindings.findChildViewById(rootView, id);
      if (compartilhar == null) {
        break missingId;
      }

      id = R.id.criar;
      Button criar = ViewBindings.findChildViewById(rootView, id);
      if (criar == null) {
        break missingId;
      }
